...
{
    public class UsersPostsCountViewModel : ObservableObject
    {
        private readonly IUserService userService;

        public UsersPostsCountViewModel(IUserService userService, IPostService postService)
        {
        ...
        public ObservableCollection<UsersPostsCountDto> Items { get; set; }
        ...
        {
            Items = new ObservableCollection<UsersPostsCountDto>(await userService.GetUsersPostsCountAsync(skip, take));
